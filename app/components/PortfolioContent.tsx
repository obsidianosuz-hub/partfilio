                        ...
                        <div className="glass-card flex flex-col p-0 overflow-hidden bg-[rgba(15,23,42,0.4)] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.4)] transition-all duration-300 border border-white/10 rounded-3xl fade-in-up">
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                ...
                                <div className="grid grid-cols-2 gap-6 mt-auto pt-8">
                                    <a href="#" className="project-btn btn-github" style={{ clipPath: 'polygon(12px 0, calc(100% - 12px) 0, 100% 12px, 100% calc(100% - 12px), calc(100% - 12px) 100%, 12px 100%, 0 calc(100% - 12px), 0 12px)' }}>
                                    ...
                                    <Link href="/projects/gym/demo" className="project-btn btn-demo group overflow-hidden" style={{ clipPath: 'polygon(12px 0, calc(100% - 12px) 0, 100% 12px, 100% calc(100% - 12px), calc(100% - 12px) 100%, 12px 100%, 0 calc(100% - 12px), 0 12px)' }}>
